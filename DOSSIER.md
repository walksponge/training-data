...
| Type | Description |
|------|-------------|
| Primary | Triathlon performance (Endurance) |
| Secondary | Running |
...
| Goal | Target Date |
|------|-------------|
| Half-marathon | 03/2026 |
| Half-ironman| 07/2026 |

**Current Phase:** [ Aerobic build + threshold development]  
**Training Style:** [quality over quantity and more important avoid injury]
